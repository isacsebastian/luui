    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className={`text-3xl lg:text-4xl font-bold text-[#0077B6] mb-4 transition-all duration-1000 ${
            isVisible 
              ? 'opacity-100 translate-y-0' 
              : 'opacity-0 translate-y-8'
          }`}>
            Adultos mayores: una realidad que requiere atención
          </h2>
          <div className={`w-24 h-1 bg-gradient-to-r from-[#56A6E9] to-[#0077B6] rounded-full mx-auto transition-all duration-1000 delay-300 ${
            isVisible 
          ...
          {statistics.map((stat, index) => (
            ...
            >
              ...
              <div className={`relative mb-6 transition-all duration-500 ${
                ...
                <div className={`absolute inset-0 w-32 h-32 mx-auto rounded-full bg-gradient-to-br from-[#56A6E9]/20 to-[#0077B6]/20 transition-all duration-1000 ${
              ...
              <div className={`w-12 h-0.5 bg-[#56A6E9] mx-auto mt-4 transition-all duration-700 ${
        ...
        <div className={`text-center mt-16 transition-all duration-1000 delay-1000 ${
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            En Luuí trabajamos para cambiar estas estadísticas, brindando cuidado profesional 
            y apoyo integral a nuestros adultos mayores.
          </p>
        </div>
      </div>
    </section>
